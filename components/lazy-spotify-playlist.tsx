    ...
    <div ref={containerRef} className={`relative ${className}`}>
      ...
      <div className="mb-4 flex justify-center">
        <a
          ...
          className="btn-primary bg-white hover:bg-gray-100 text-black px-3 md:px-8 py-3 md:py-4 text-sm md:text-base shadow-lg transition-all duration-200 flex items-center justify-center gap-2 rounded-md"
        >
